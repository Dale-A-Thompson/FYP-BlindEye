...
final class DeletePaletteDialogFragmentFlavour {
    //AlertDialog that asks the user to confirm deletion of a ColourItem
    static AlertDialog dialogCreation(Context context, final Palette palette, final DeletePaletteDialogFragment.Callback callback) {
